...
CREATE TABLE IF NOT EXISTS watches (
  ...
  dial_color varchar(128),
  bracelet_material varchar(128),
  ...
  publication_status watch_publication_status NOT NULL DEFAULT 'published',
  category varchar(128),
  tags jsonb NOT NULL DEFAULT '[]'::jsonb,
  featured boolean NOT NULL DEFAULT false,
  hype boolean NOT NULL DEFAULT false,
