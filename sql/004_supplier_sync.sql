...
ALTER TABLE product_categories ADD COLUMN IF NOT EXISTS markup_percent numeric(8, 2);
ALTER TABLE product_categories ADD COLUMN IF NOT EXISTS fixed_fee numeric(14, 2);
ALTER TABLE product_categories ADD COLUMN IF NOT EXISTS rounding_rule varchar(32) NOT NULL DEFAULT 'nearest_50';
...
FROM (VALUES
  ('Montres homme', 'montres-homme', 'montres'),
  ('Montres femme', 'montres-femme', 'montres'),
  ('Montres unisexe', 'montres-unisexe', 'montres'),
  ('Sacs a main', 'sacs-a-main', 'sacs'),
  ('Petite maroquinerie', 'petite-maroquinerie', 'sacs'),
  ('Sneakers', 'sneakers', 'chaussures'),
  ('Souliers', 'souliers', 'chaussures'),
  ('Vestes', 'vestes', 'vetements'),
  ('Chemises', 'chemises', 'vetements'),
  ('Bagues', 'bagues', 'bijoux'),
  ('Bracelets', 'bracelets', 'bijoux'),
  ('Lunettes', 'lunettes', 'accessoires')
